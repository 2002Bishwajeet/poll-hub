...
>
  ...
  <div class="box u-stretch">
    <h1 class="heading-level-2 u-text-center">Password Recovery</h1>
    <form class="form u-margin-block-start-24">
      ...
      <div class="form-footer">
        <button class="button u-width-full-line u-main-center" type="submit">
          Recover
        </button>

        <div
          class="u-flex u-main-center u-cross-center u-gap-8 u-margin-block-start-12"
        >
